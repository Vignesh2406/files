...
public class Deck1
{
   private List<Card1> cards;    //contains all the cards in the deck
    ...
    */
   public Deck1(String[] ranks, String[] suits, int[] values)
   {
       ...
       for(int b = 0; b < suits.length; b++)
        {
            ...
            {
                Card1 xCard = new Card1(ranks[a], suits[b], values[a]);
...
/**
   ...
   public void shuffle()
   {
    ...
    {
        Random zvariable = new Random();
        for (int y = cards.size() - 1; y >= 0; y--)
        {
            int index1 = zvariable.nextInt(cards.size() - 1);
            Card1 b = cards.get(y);
            cards.set(y, cards.get(index1));
            cards.set(index1, b);
        }
    }
   }
