...
public class Magpie4
{
    ...
    public String getResponse(String statement)
    {
        ...
        //Below code added for Activity 4
    ...
    {
        //Three responses added to array for Activity 5
        String [] randomResponses = {"Interesting, tell me more",
                                     "Hmmm.",
                                     "Do you really think so?",
                                     "You don't say.",
                                     "Yeah boi, go for it!",
                                     "Are you sure that\'s is the best idea?",
        ...
        //Code edit for Activity 5
        response = randomResponses[(int)(Math.random()*NUMBER_OF_RESPONSES)];
        
        //Code below commented out for Activity 5
        /**if (whichResponse == 0)
        {
